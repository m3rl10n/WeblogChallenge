...
// 
// The solution was done via Spark RDD APIs. I will preface the code with I am new to Spark and Scala. 
// With more time and farmiliarity with spark / sbt / spark-testing frameworks I would improve the code by 
